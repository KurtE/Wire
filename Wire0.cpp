...
uint8_t TwoWire0::rxBuffer[BUFFER_LENGTH];
uint8_t TwoWire0::rxBufferIndex = 0;
uint8_t TwoWire0::rxBufferLength = 0;

uint8_t TwoWire0::txAddress = 0;
uint8_t TwoWire0::txBuffer[BUFFER_LENGTH];
uint8_t TwoWire0::txBufferIndex = 0;
uint8_t TwoWire0::txBufferLength = 0;

uint8_t TwoWire0::transmitting = 0;
void (*TwoWire0::user_onRequest)(void);
void (*TwoWire0::user_onReceive)(int);
...
void TwoWire0::begin(int address)
{
...
void TwoWire0::setClock(uint32_t frequency)
{
...
uint8_t TwoWire0::requestFrom(uint8_t address, uint8_t quantity, uint8_t sendStop)
{
...
uint8_t TwoWire0::requestFrom(uint8_t address, uint8_t quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}

uint8_t TwoWire0::requestFrom(int address, int quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}

uint8_t TwoWire0::requestFrom(int address, int quantity, int sendStop)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)sendStop);
}

void TwoWire0::beginTransmission(uint8_t address)
{
...
void TwoWire0::beginTransmission(int address)
{
...
//
uint8_t TwoWire0::endTransmission(uint8_t sendStop)
{
...
//
uint8_t TwoWire0::endTransmission(void)
{
...
size_t TwoWire0::write(uint8_t data)
{
  if(transmitting){
...
// slave tx event callback
// or after beginTransmission(address)
size_t TwoWire0::write(const uint8_t *data, size_t quantity)
{
  if(transmitting){
  // in master transmitter mode
...
void TwoWire0::flush(void)
{
  // XXX: to be implemented.
}

// behind the scenes function that is called when data is received
void TwoWire0::onReceiveService(uint8_t* inBytes, int numBytes)
{
...
void TwoWire0::onRequestService(void)
{
  // don't bother if user hasn't registered a callback
  if(!user_onRequest){
    return;
...
void TwoWire0::onReceive( void (*function)(int) )
{
  user_onReceive = function;
}

// sets function called on slave read
void TwoWire0::onRequest( void (*function)(void) )
{
